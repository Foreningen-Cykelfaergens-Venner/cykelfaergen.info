...
<main class="container">
    <article class="subbanner">
        <section class="search-container-bg">
            <img class="search-container-bg-img subbanner-img" src="/images/bg/sonderborg/Byens havn (2).jpg" alt="Sønderborg - Byens havn">
    ...
    <section class="ppad-about">
        <section class="grid grid-gap">
            ...
            <section class="about__imageContainer">
                <img class="aboutSmallImages" src="/images/sonderborg/Rådhustorvet_Sønderborg_0013-1600px.jpg" alt="Sønderborg Rådhustorvet">
                <small class="photo-copy-underImage">&copy; Sønderborg Kommune</small>
            </section>
        </section>
        <section class="grid grid-gap">
            <section class="about__imageContainer">
                <img class="aboutSmallImages --leftSide" src="/images/broager/Broagerkirke.jpg" alt="Broager Kirke">
                <small class="photo-copy-underImage">&copy; Sønderborg Kommune</small>
            </section>
            <section class="about-content">
        ...
        <section class="grid grid-gap">
            ...
            <section class="about__imageContainer">
                <img class="aboutSmallImages" src="/images/langballig/Hafenidylle Langballigau-BenjaminNolte.jpg" alt="Hafenidylle Langballigau">
