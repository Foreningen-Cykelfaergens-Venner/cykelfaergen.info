<?
    if(isset($_COOKIE["region"]) && $_COOKIE["region"] == "dk-DK"){
        $title = "Vores historie | Cykelfærgen Rødsand";
        ...
        $title = "Unsere Geschitche | Fahrradfähre Rødsand";
        ...
        $title = "Our history | Bicycle ferry Rødsand";
...
?>
    ...
    <?
        if(isset($_COOKIE["region"]) && $_COOKIE["region"] == "da-DK"){
            include($_SERVER["DOCUMENT_ROOT"]."/language/dk-DK/our-history.php");
            ...
            include($_SERVER["DOCUMENT_ROOT"]."/language/de-DE/our-history.php");
            ...
            include($_SERVER["DOCUMENT_ROOT"]."/language/en-GB/our-history.php");
