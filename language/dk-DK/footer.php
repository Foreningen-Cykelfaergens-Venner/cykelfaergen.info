<footer class="footer <?= $tourdefrance;?>">
    <section class="footer_nav ppad">
        <div class="footer_logo">
            <img src="https://<?= $mainHost?>/assets/logo/logo.svg" width="256px" height="256px" alt="Cykelfærgen Logo">
        </div>
        <section class="navigation-status">
            ...
            <section class="invest le">
                ...
                <ul>
                    ...
                    <li><a href="https://<?= $mainHost?>/contact">Kontakt os</a></li>
                </ul>
            </section>
            <section class="invest le">
                <div class="footer--title">Forening</div>
                <ul>
                    <li><a href="https://<?= $mainHost?>/om-os/forening/cykelfaergens-venner/bestyrelsen">Bestyrelsen</a></li>
                ...
                <a href="https://www.mobilepay.dk/erhverv/betalingslink/betalingslink-svar?phone=779913" target="_blank" rel="noopener noreferrer"><img style="max-width:40%; padding: 20px 0px;" src="https://<?= $mainHost?>/assets/logo/MP_RGB_NoTM_Logo+Type Horisontal Blue.svg" alt="MobilePay"></a>
                <ul>
            ...
            <section class="invest le">
                <section>
                    ...
                    <a href="https://www.instagram.com/cykelfaergen.flensborg.fjord/" target="_blank" rel="noopener noreferrer"><img class="social-icon" width="40px" height="40px" src="https://<?= $mainHost?>/assets/icons/instagram.svg" title="Følg os på Instagram" alt="Instagram logo"></a>
                    <div class="clear"></div>
                </section>
                <section>
    ...
    <div class="legal">
        <div class="legalc">
            <div class="terms">
                <div class="vfb"><a href="https://<?php echo $mainHost?>/frivillige-login">Frivilige Login</a></div>
                <div class="vfb"><a href="https://<?php echo $mainHost?>/om-os/legal/terms-of-service">Terms of Services</a></div>
                <div class="dp"><a href="https://<?php echo $mainHost?>/om-os/legal/privacy">Privatlivs politik</a></div>
                <div class="dp"><a href="https://<?php echo $mainHost?>/om-os/legal/cookie-policy">Cookie politik</a></div>
                <div class="impr"><a href="https://<?php echo $mainHost?>/imprint">Impressum</a></div>
            </div>
