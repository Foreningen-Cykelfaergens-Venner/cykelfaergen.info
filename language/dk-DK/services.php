<section class="ppad-about">
    <section class="grid grid-gap content Tpadding">
        <section class="about-content">
            <h1 class="about-heading">Sønderjylland med <span class="rare-script">skib</span> og <span class="rare-script">på cykel</span></h1>
...
<section class="split-tout--padding-top">
    <section class="grid grid-gap content Tpadding">
        <section class="about-content reverse">
            <h2 class="about-heading">Servicestationer rund om din <span class="rare-script">cykel</span></h2>
            <p>Hvis du besøger Sønderjylland på cykel, kan du finde Bike Friends overalt i området, som tilbyder cyklister forskellige tjenester i forbindelse med cykling. Du kan finde et kort over servicestationerne her: <a href="https://www.visitsonderjylland.dk/turist/oplevelser/cykling/bikestations" target="_blank" rel="nofollow noopener">Bikestations i Sønderjylland | VisitSønderjylland (visitsonderjylland.dk)</a></p>
        </section>
        <section class="about__imageContainer">
