<?
    if(isset($_COOKIE["region"]) && $_COOKIE["region"] == "dk-DK"){
        $title = "Rejseregler - Cykelfærgen Rødsand";
        ...
        $title = "Reiseregeln - Cykelfærgen Rødsand";
...
<head>
    ...
    <meta property="og:url" content="https://www.cykelfaergen.info" />
    ...
    <script src="https://www.intastellarsolutions.com/js/cookie-banner.js"></script>
    <script>
...
<?
    if(isset($_COOKIE["region"]) && $_COOKIE["region"] == "dk-DK"){
        ...
        include($_SERVER["DOCUMENT_ROOT"]."/language/dk-DK/rejseRegler-banner.php");
        include($_SERVER["DOCUMENT_ROOT"]."/language/dk-DK/rejseRegler-container.php");
        ...
        include($_SERVER["DOCUMENT_ROOT"]."/language/de-DE/rejseRegler-banner.php");
        include($_SERVER["DOCUMENT_ROOT"]."/language/de-DE/rejseRegler-container.php");
        ...
        include($_SERVER["DOCUMENT_ROOT"]."/language/en-GB/rejseRegler-banner.php");
        include($_SERVER["DOCUMENT_ROOT"]."/language/en-GB/rejseRegler-container.php");
