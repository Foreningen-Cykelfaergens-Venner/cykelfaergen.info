<article class="hero__slider search-container">
    <section class="search-container-bg">
        <img class="search-container-bg-img" src="/assets/gendarmstien/IMG_1164-480w.jpg" alt="Happy people enjoying a ferry ride" srcset="/assets/gendarmstien/IMG_1164-480w.jpg 480w, /assets/gendarmstien/IMG_1164-800w.jpg 800w, /assets/gendarmstien/IMG_1164.jpg 1200w">
    ...
    <section class="search-container-content">
        <h2>Verein der "Freunde der Fahrradfähre"</h2>
        <p>Saison 2023 ist Vorbei!</p>
        <h1 class="search-container-heading">Werde ein Teil des Vereins & unterstützen Sie das Projekt</h1>
        <p>Möchten Sie das Projekt „Fahrradfähre“ an der Flensburger Förde mitgestalten? Dann können Sie es noch heute mit einer Jahresmitgliedschaft und einer Unterstützung von 100 DKK tun.</p>
        <p>Der Verein der "Freunde der Fahrradfähre" entwickelt und unterstützt das Projekt Fahrradfähre auf der Flensburger Förde.</p>
        <div class="reviews">
            <div class="fb rating">
                <div class="stars">
        ...
        <section class="btn_container">
            <a href="https://www.cykelfaergen.info/om-os/forening/cykelfaergens-venner" class="btn btn-second">Weitere infos</a>
            <a href="https://verein.cykelfaergen.info/mitgliedschaft" class="btn hero-btn">Du als neuer Freund<i class="arrow down-arrow"></i></a>
        </section>
