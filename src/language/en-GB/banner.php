<article class="hero__slider search-container">
    ...
    <section class="search-container-content">
        <h3>Bookings 2024 are open!</h3>
        <h1 class="search-container-heading">Travel to a new land in just 25 minutes</h1>
        <div class="reviews" itemscope itemtype="https://schema.org/Product">
            <div class="fb rating">
                <div class="stars">
                    ...
                    <meta itemprop="name" content="Cykelfærgen Flensborg Fjord - Facebook" />
            ...
            <div class="truspilot rating">
                <div class="stars">
                    ...
                    <meta itemprop="name" content="Cykelfærgen Flensborg Fjord - Trustpilot" />
                    <div itemprop="review" itemtype="https://schema.org/Review" itemscope>
                        <div itemprop="author" itemtype="https://schema.org/Person" itemscope>
                            <meta itemprop="name" content="Fred Benson" />
                        </div>
            ...
            <div class="google rating">
                <div class="stars">
                    ...
                    <meta itemprop="name" content="Cykelfærgen Flensborg Fjord - Google" />
                    <div itemprop="review" itemtype="https://schema.org/Review" itemscope>
                        <div itemprop="author" itemtype="https://schema.org/Person" itemscope>
                            <meta itemprop="name" content="Fred Benson" />
                        </div>
                ...
                <a href="https://www.google.com/search?cs=1&output=search&q=Cykelfærgen+Flensborg+fjord&ludocid=18334368944837627769&gsas=1&client=safari&lsig=AB86z5WFs3vNT0LdaEbq_eHgxL0H&sa=X&ved=2ahUKEwiKpMfbwKb-AhXC_aQKHeMqD50Qj9IGKAB6BAgYEAE&biw=1440&bih=743&dpr=2" target="_blank" rel="noopener noreferrer">Google reviews</a>
            </div>
        </div>
        <section class="btn_container">
            <a href="#tickets" class="btn btn-second">Find prices</a>
            <a href="https://booking.cykelfaergen.info?utm_campaign=Booking2024&utm_source=hero-banner&utm_medium=banner&utm_content=Secure+your+ticket+today!" onclick='gtag("event", "generate_lead", {
                "value": 100,
                "currency": "DKK",
                "event_category": "Cykelfærgen - Bookig",
                "event_label": "Secure your ticket today!"
            }), fbq("Lead", {
                "content_category": "Cykelfærgen - Bookig",
                "content_name": "Secure your ticket today!"
            })' class="btn hero-btn">Secure your ticket today! <i class="arrow down-arrow"></i></a>
        </section>
        <iframe class="hero-video" src="https://www.youtube-nocookie.com/embed/ToPYUlPbhRg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </section>
</article>