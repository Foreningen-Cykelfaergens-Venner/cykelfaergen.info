<article class="hero__slider search-container">
    ...
    <section class="search-container-content">
        <h1 class="search-container-heading">5 års Jubilæum</h1>
        <p>Vær med til at fejre vores 5-års jubilæum og stig om bord på vores ny færge Thjalfe.</p>
        ...
        <section class="btn_container">
            <a href="/jubilaeum" class="btn">Læs mere</a>
            <a href="https://booking.cykelfaergen.info?utm_campaign=Booking2023&utm_source=hero-banner&utm_medium=banner&utm_content=Book+din+25+min.+sejlads" onclick='gtag("event", "generate_lead", {
                ...
                "event_label": "Book din sejlads her - Jubilæum"
            }),fbq("Lead", {
                "content_category": "Cykelfærgen - Bookig",
                "content_name": "Book din sejlads her - Jubilæum"
            })' class="btn">Book din sejlads her<i class="arrow down-arrow"></i></a>
        </section>
