<article class="hero__slider search-container">
    ...
    <section class="search-container-content">
        ...
        <p>Sæsonen 2023 er slut, vi glæder os til næste år. Støt vores arbejde også uden for sæsonen med et årlig bidrag.</p>
        <h1 class="search-container-heading">Meld dig ind og støt projektet</h1>
        <p>Vil du hjælpe med at udvikle projektet Cykelfærgen på Flensborg fjord? Så kan du gøre det i dag med et årlig medlemsskab og støtte på 100 kr.</p>
        <p>Foreningen Cykelfærgens Venner udvikler og støtter projektet Cykelfærgen på Flensborg fjord. Hver med fra i dag</p>
        <div class="reviews">
            <div class="fb rating">
                <div class="stars">
        ...
        <section class="btn_container">
            <a href="https://www.cykelfaergen.info/om-os/forening/cykelfaergens-venner" class="btn btn-second">Læs mere</a>
            <a href="https://forening.cykelfaergen.info/medlemsskab" class="btn hero-btn">Meld dig ind<i class="arrow down-arrow"></i></a>
        </section>
