    ...
    <section class="search-container-content">
        ...
        <div class="reviews">
            ...
            <div class="google rating">
                ...
                <a href="https://www.google.com/search?cs=1&output=search&q=Cykelfærgen+Flensborg+fjord&ludocid=18334368944837627769&gsas=1&lsig=AB86z5WFs3vNT0LdaEbq_eHgxL0H&sa=X&ved=2ahUKEwiKpMfbwKb-AhXC_aQKHeMqD50Qj9IGKAB6BAgYEAE" target="_blank" rel="noopener noreferrer">Google reviews</a>
            </div>
        </div>
        <section class="btn_container">
            <a href="https://forening.cykelfaergen.info/medlemsskab" class="btn btn-second">Støt foreningen</a>
            <a href="https://booking.cykelfaergen.info?utm_campaign=Booking2024&utm_source=hero-banner&utm_medium=banner&utm_content=Book+din+25+min.+sejlads" onclick='gtag("event", "generate_lead", {
                "value": 100,
                "currency": "DKK",
                "event_category": "Cykelfærgen - Bookig",
                "event_label": "Check ledige pladser"
            }),fbq("Lead", {
                "content_category": "Cykelfærgen - Bookig",
                "content_name": "Check ledige pladser"
            })' class="btn hero-btn">Check ledige pladser<i class="arrow down-arrow"></i></a>
        </section>
        <video src="/assets/vid/cykelfaergen-reklame.mp4" width="560px" height="315px" controls aria-controls="" class="hero-video"></video>
        <!-- <iframe class="hero-video" src="https://www.youtube-nocookie.com/embed/dOa0jxxEuyg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> -->
    </section>
</article>