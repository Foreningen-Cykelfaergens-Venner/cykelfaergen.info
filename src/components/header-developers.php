...
if(isset($_SERVER['HTTP_REFERER']) && $_SERVER['HTTP_REFERER'] == "https://www.fahrradfaehre.info/"){
...
if (strpos($_SERVER["REQUEST_URI"], "pressroom") !== false) {
  ...
  $img = "https://".$mainHost."/assets/og_images/cykelfærgen-og-main.jpg?v=". time();
}
...
if (isset($_COOKIE["region"]) && $_COOKIE["region"] == "da-DK") {
  if($_SERVER["REQUEST_URI"] == "/" && $_SERVER["HTTP_HOST"] !== "booking.cykelfaergen.info" && $_SERVER["HTTP_HOST"] !== "configurator.cykelfaergen.info"){
    ...
    if($_SERVER["REQUEST_URI"] == "/" && $_SERVER["HTTP_HOST"] !== "booking.cykelfaergen.info"){
      $title = "Ab in die Ferien nach Dänemark, mit einer 25 minutten Fährefahrt| Fahrradfähre Flensburger Förde";
...
<head>
  ...
  <? if (strpos($_SERVER["REQUEST_URI"], "om-os/forening") !== false || strpos($_SERVER["HTTP_HOST"], "forening.cykelfaergen.info") !== false || strpos($_SERVER["HTTP_HOST"], "verein.cykelfaergen.info") !== false) { ?>
    <link rel="stylesheet" href="https://<?= $mainHost;?>/styles/forening.css">
  <? } ?>
  <?= $style; ?>
  ...
  <script src="https://<?= $mainHost;?>/js/reviews.js?v=<?php echo time(); ?>" defer></script>
  ...
  <script type="application/ld+json">
      {
        ...
        "duration": "PT1M04S",
        "contentUrl": "https://www.cykelfaergen.info/assets/vid/dji_fly_20220920_102936_363_1663664358521_video.MP4"
      }
    </script>
  <? if (strpos($_SERVER["REQUEST_URI"], "om-os/forening") !== false) { ?>
    <script src="https://<?= $mainHost;?>/js/min/payment.min.js" defer></script>
    <script type="application/ld+json">
      {
        "@context": "http://schema.org",
        "@type": "Product",
        "name": "Passiv medlem",
        "image": "https://www.cykelfaergen.info/assets/Scgoreenshot 2022-10-12 at 10.26.24.png",
        "description": "Som passiv medlem støtter du Foreningen Cykelfærgen´s Venner og der med Cykelfærgen på Flensborg fjord. Dit bidrag hjælper foreningen til at udvikle vider på konceptet.",
        "brand": {
          "@type": "Brand",
...
<!-- End Google Tag Manager -->
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-4WV9WHRH6N" type="text/plain"></script>
  <script>
...
<section class="test">
    <? include($root. "/functions/developer-info.php");?>
  </section>
  <?
  include($root . "/language/" . $region . "/header-developers.php");
  ?>