<?php
    ...
    if(isset($_COOKIE["region"]) && $_COOKIE["region"] == "da-DK" && $_SERVER["REQUEST_URI"] !== "/attraktioner"){
        header("Location: /attraktioner");
    ...
    $title = "Attraktionen rund um die Flensburger Förde";
    include($_SERVER["DOCUMENT_ROOT"] . "/components/header.php");
?>
    <main class="container content">
        <h1>Attraktionen rund um die Flensburger Förde</h1>
        <p>Find her en liste over attraktioner, hoteller og lignede, rundt om Flensborg fjord, som du kan kombinere med en sejlads på Cykelfærgen.</p>
        <section class="attractions grid">
            <a href="https://www.museum-unewatt.de" target="_blank" class="attraction-item">
                ...
                <p>Tag med os en udflugt til Landschaftsmuseum Angeln/Unewatt</p>
            </a>
