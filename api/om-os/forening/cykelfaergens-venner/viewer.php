<?
    if(isset($_COOKIE["region"]) && $_COOKIE["region"] == "dk-DK"){
        $title = $_GET["title"]." | Foreningen Cykelfaergen's Venner";
...
<?
    ...
    ?>
    <main class="mt">
        <iframe src="https://view.officeapps.live.com/op/embed.aspx?src=https://www.cykelfaergen.info/docs/<?= $_GET["file"]?>&amp;wdEmbedCode=0&amp;wdPrint=1&amp;wdAccPdf=0" frameborder="0" width="100%" height="580px"></iframe>
    </main>
    <?
