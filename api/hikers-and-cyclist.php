...
<main class="container">
    <section class="ppad-about">
        <section class="grid grid-gap content Tpadding">
            ...
            <section class="about__imageContainer">
                <img class="overlap-bottom aboutSmallImages" src="https://www.cykelfaergen.info/images/20190725-_7251972.jpg" alt="Fähre auf der Flensburger Förde mit Personen">
            </section>
        </section>
    </section>
    <section class="ppad-about">
        <section class="about__bg split-tout--padding-top">
            <section class="grid content Tpadding">
                <section class="about__imageContainer reverse">
                    <img class="overlap-bottom aboutSmallImages" src="https://www.cykelfaergen.info/images/brunsnæs-langballigau.jpg" alt="Dannebrog hinter der Fähre im Winde">
                </section>
                <section class="about-content">
    ...
    <section class="split-tout--padding-top">
        <section class="grid grid-gap content Tpadding">
            ...
            <section class="about__imageContainer">
                <img class="aboutSmallImages" src="https://www.intastellarsolutions.comhttps://www.cykelfaergen.info/images/bg/ftr_bg.png" alt="Die Fähre Rødsand auf dem weg nach Brunsnæs">
            </section>
        </section>
    </section>
    <section class="ppad-about" style="padding-bottom: 0px;">
        <section class="about__bg">
            <section class="grid content Tpadding">
                <section class="about__imageContainer">
                    <!-- <img class="overlap-top aboutSmallImages" src="https://www.cykelfaergen.info/images/personen-about/cathrinesminde-ziegeleimuseum-in-brunsnaes-.jpg" alt="Cathrinesminde von der Seeseite aus gesehen."> -->
                </section>
