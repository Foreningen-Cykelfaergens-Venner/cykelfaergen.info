<section class="ppad-about">
    <section class="grid grid-gap content Tpadding">
        <section class="about-content">
            <h1 class="about-heading">Sønderjylland per Schiff und Fahrrad</h1>
...
<section class="split-tout--padding-top">
    <section class="grid grid-gap content Tpadding">
        <section class="about-content reverse">
            <h2 class="about-heading">Servicestationen rund ums Fahrrad</h2>
            <p>Wer Sønderjylland mit dem Rad besucht, findet in diesem Gebiet überall die Bike Friends, die Radfahrern verschiedene Services rund um das Rad anbieten. Eine Übersichtskarte der Servicestationen findest du hier: <a href="https://www.visitsonderjylland.de/BikeFriendsDE" target="_blank" rel="nofollow noopener">Die Bike Friends in Sønderjylland | VisitSønderjyllanda></p>
        </section>
        <section class="about__imageContainer">
