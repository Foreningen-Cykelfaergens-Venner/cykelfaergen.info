<?
    ...
    if(isset($_COOKIE["region"]) && $_COOKIE["region"] == "dk-DK"){
        $title = "Cykelfærgen Rødsand - Egernsund-Brunsnæs-Langballigau-Flensburg";
        ...
        $title = "Fahrradfähre Rødsand - Egernsund-Brunsnæs-Langballigau-Flensburg";
        ...
        $title = "Bicycle ferry Rødsand, Egernsund-Brunsnæs-Langballigau-Flensburg";
